...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._rich_always_enabled = self._coerce_bool_extra("rich_always", False)
        self._rich_messages_enabled: bool = self._coerce_bool_extra("rich_messages", False) or self._rich_always_enabled
    ...
    def _rich_eligible(self, content: str) -> bool:
        ...
        return bool(
            ...
            and (getattr(self, "_rich_always_enabled", False) or self._needs_rich_rendering(content))
